...
import { IActivityActions } from "../reducers/activity.reducer"
...
export default function ActivityList({ activities, dispatch }: IActivityListProps) {

    const categoryName = useMemo(() =>
        (category: IActivity['category']) => categories.map(cat => cat.id === category ? cat.name : '')
        , [activities])
